...
export default function NewPaymentPage() {
  ...
  return (
    <div className="max-w-xl mx-auto">
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Nová platba</h1>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Card className="mb-4">
          ...
          <CardContent className="space-y-4">
            <div>
              <label className="text-sm font-medium text-gray-700">Typ platby <span className="text-red-500">*</span></label>
              <select name="type" required className="mt-1 flex h-10 w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className="text-sm font-medium text-gray-700">Částka (Kč) <span className="text-red-500">*</span></label>
                <Input name="amount" type="number" step="0.01" required className="mt-1" />
              </div>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-700">Způsob platby <span className="text-red-500">*</span></label>
              <select name="method" required className="mt-1 flex h-10 w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="text-sm font-medium text-gray-700">Variabilní symbol</label>
                <Input name="variableSymbol" className="mt-1" />
              </div>
              <div>
                <label className="text-sm font-medium text-gray-700">Reference banky</label>
                <Input name="bankReference" className="mt-1" />
              </div>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-700">Poznámka</label>
              <textarea
                name="note"
