  ...
  return (
    <div className="page-enter space-y-6">
      ...
      <div className="flex items-end justify-between">
        ...
        <Badge variant="outline" className="text-gray-500 font-medium hidden sm:flex">
          PlusHouse ERP
        </Badge>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
        <Card className="card-hover stat-card-blue overflow-hidden rounded-2xl border-0 shadow-sm">
          <CardContent className="p-5">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-500">Kontakty</p>
        ...
        <Card className="card-hover stat-card-green overflow-hidden rounded-2xl border-0 shadow-sm">
          <CardContent className="p-5">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-500">Zaměstnanci</p>
                <p className="text-2xl font-bold text-gray-900 mt-1">
        ...
        <Card className="card-hover stat-card-purple overflow-hidden rounded-2xl border-0 shadow-sm">
          <CardContent className="p-5">
            <div className="flex items-center justify-between">
              <div>
            ...
            <div className="space-y-3">
              {stats.overdueInvoices > 0 && (
                <Link
                  ...
                  style={{
                    ...
                    borderImage: "linear-gradient(to bottom, #dc2626, #f59e0b) 1",
              ...
              {stats.totalContacts === 0 && (
                <Link
                  ...
                  style={{
                    borderLeft: "4px solid transparent",
                    borderImage: "linear-gradient(to bottom, #eab308, #f97316) 1",
              ...
              {stats.overdueInvoices === 0 && stats.totalContacts > 0 && (
                <div
                  ...
                  style={{
                    borderLeft: "4px solid transparent",
                    borderImage: "linear-gradient(to bottom, #16a34a, #059669) 1",
          ...
          <CardContent>
            {stats.recentPayments.length === 0 ? (
              <div className="text-center py-10">
                <div className="p-3 rounded-2xl bg-gray-50 inline-block mb-3">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="bg-gray-50/80">
                      <th className="text-left px-4 py-2.5 font-semibold text-gray-500 text-xs uppercase tracking-wider">
                        Subjekt
                      </th>
                      <th className="text-left px-4 py-2.5 font-semibold text-gray-500 text-xs uppercase tracking-wider">
                        Datum
                      </th>
                      <th className="text-right px-4 py-2.5 font-semibold text-gray-500 text-xs uppercase tracking-wider">
                        Částka
                      </th>
                    </tr>
                  </thead>
                        ...
                        <td className="px-4 py-3 text-right">
                          <span
                            className={`font-semibold ${
                              p.type === "INCOMING" ? "text-green-600" : "text-red-600"
                            }`}
                          >
                            {p.type === "INCOMING" ? "+" : "-"}
      ...
      {/* Quick Actions */}
      <div>
        <h2 className="text-base font-bold text-gray-900 mb-4">Rychlé akce</h2>
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <Link href="/faktury/nova" className="group">
            <Card className="card-hover overflow-hidden rounded-2xl border-0 shadow-sm transition-all group-hover:shadow-md">
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <ChevronRight className="h-5 w-5 text-gray-300 group-hover:text-blue-500 transition-colors mt-0.5" />
                </div>
              </CardContent>
            </Card>
          </Link>
            ...
            <Card className="card-hover overflow-hidden rounded-2xl border-0 shadow-sm transition-all group-hover:shadow-md">
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <ChevronRight className="h-5 w-5 text-gray-300 group-hover:text-green-500 transition-colors mt-0.5" />
                </div>
              </CardContent>
            </Card>
          </Link>
            ...
            <Card className="card-hover overflow-hidden rounded-2xl border-0 shadow-sm transition-all group-hover:shadow-md">
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <ChevronRight className="h-5 w-5 text-gray-300 group-hover:text-purple-500 transition-colors mt-0.5" />
                </div>
              </CardContent>
            </Card>
          </Link>
