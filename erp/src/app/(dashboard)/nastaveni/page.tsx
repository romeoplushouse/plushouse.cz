      ...
      <form onSubmit={handleSave}>
        <Card className="mb-6">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="text-sm font-medium text-gray-400">Název firmy</label>
              ...
              <div>
                <label className="text-sm font-medium text-gray-400">Web</label>
                <Input value={org.website} onChange={(e) => updateField("website", e.target.value)} className="mt-1" />
              </div>
              <div>
                <label className="text-sm font-medium text-gray-400">Zápis v OR</label>
        ...
        <Card className="mb-6">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="text-sm font-medium text-gray-400">IBAN / Číslo účtu</label>
                <Input value={org.bankAccount} onChange={(e) => updateField("bankAccount", e.target.value)} className="mt-1" />
              </div>
              <div>
                <label className="text-sm font-medium text-gray-400">Kód banky</label>
        ...
        <div className="flex items-center gap-3">
          ...
          {saved && (
            <span className="text-emerald-400 text-sm font-medium">Uloženo!</span>
          )}
        </div>
      </form>
